...
class CountryService:
    ...
    def get_all_countries(self) -> list[CountryEntity]:
        ...
        Returns:
            list[CountryEntiry]: this will return al list of the CountryEntity
        """
    ...
    def get_country_by_id(self, country_id: int) -> CountryEntity:
        ...
        Returns:
            CountryEntity: Te country if found
        """
    ...
    def update_country(self, country_id: int, country: CountryEntity) -> CountryEntity:
        ...
        Args:
            country_id (int): ID of country to update
            country (CountryEntity):

        Returns:
            CountryEntity: updated country
        """
    ...
    def delete_country(self, country_id: int) -> bool:
        ...
        Args:
            country_id (int): ID of contry to delete
